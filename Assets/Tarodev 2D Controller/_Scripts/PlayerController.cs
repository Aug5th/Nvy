...
namespace TarodevController
{
    ...
    public class PlayerController : MonoBehaviour, IPlayerController
    {
        ...
        private void HandleJump()
        {
            ...
            if (!_jumpToConsume && !HasBufferedJump || _wallSliding) return;
        ...
        private void HandleWallJump()
        {
            if (_wallSliding)
            {
                _wallJumpCounter = _wallJumpDuration;
                // CancelInvoke("SetWallJumping");
            }
            else
            {
            ...
            if (_jumpToConsume && _wallSliding)
            {
                ExecuteWallJump();
            }
        ...
        private void HandleGravity()
        {
            ...
            if (_wallSliding || _grounded && _frameVelocity.y <= 0f)
            {
                _frameVelocity.y = _stats.GroundingForce;
            }
            else if (_wallJumpCounter <= 0f)
            {
